...
class Index extends React.Component<IIndexProps, IIndexState> {
  ...
  async saveChanges() {
    try {
      ...
      await editModuleInfo(
        this.state.targetRegistry,
        this.state.targetStorages,
        this.state.mi
      )
      this.setState({
        isSaving: false,
  ...
  render() {
    ...
    const isAlreadyDeployed =
      !message && s.deploymentStatus === DeploymentStatus.Deployed
      ...
      <React.Fragment>
        ...
        {!isDependenciesLoading && !isDependenciesExist ? (
          <Message
            ...
            content={
              <>
                The following modules are not published in the selected
                registry:
                <br />
                ...
                <div className="ui three buttons">
                    ...
                    <Modal.Content image>
                      <Modal.Description>
                        <Message warning>
                          ...
                          Make sure the address is correct, otherwise you will
                        ...
                        <Input
                          ...
                          value={newOwner}
                          onChange={(e, data) =>
                            this.setState({ newOwner: data.value as string })
                          }
                        />
                      </Modal.Description>
                    </Modal.Content>
                  ...
                  >
                    ...
                    <Modal.Content image>
                      <Modal.Description>
                        <p>
                          Here you can (un)bind the module to make it
                          (un)accessible in modules list of website context.
                        </p>
                        <Input
                          fluid
        ...
        <Form loading={loading} style={{ marginBottom: '20px' }}>
          {s.mode === FormMode.Creating || s.mode === FormMode.Editing ? (
            <>
              ...
              <Form.Input
                ...
                value={s.mi.title ?? ''}
                onChange={(_, data) => (
                  (s.mi.title = data.value), this.setState({ mi: s.mi })
                )}
              />
              ...
              {mode === FormMode.Creating ? (
                <>
                  ...
                  <Form.Radio
                    ...
                    onChange={(_, data) =>
                      data.checked &&
                      ((mi.type = ModuleTypes.Library), this.setState({ mi }))
                    }
                  />
                  <Form.Radio
                    label="Dapplet"
                    ...
                    onChange={(_, data) =>
                      data.checked &&
                      ((mi.type = ModuleTypes.Feature), this.setState({ mi }))
                    }
                  />
                  <Form.Radio
                    label="Adapter"
                    ...
                    onChange={(_, data) =>
                      data.checked &&
                      ((mi.type = ModuleTypes.Adapter), this.setState({ mi }))
                    }
                  />
                  <Form.Radio
                    label="Interface"
                    ...
                    onChange={(_, data) =>
                      data.checked &&
                      ((mi.type = ModuleTypes.Interface), this.setState({ mi }))
                    }
                  />
          ...
          <Form.Checkbox
            ...
            onChange={(_, d) =>
              this.changeTargetStorage(StorageTypes.Swarm, d.checked)
            }
          />
          ...
          <Form.Checkbox
            ...
            onChange={(_, d) =>
              this.changeTargetStorage(StorageTypes.Sia, d.checked)
            }
          />
          ...
          <Form.Checkbox
            ...
            onChange={(_, d) =>
              this.changeTargetStorage(StorageTypes.Ipfs, d.checked)
            }
