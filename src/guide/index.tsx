  ...
  render() {
    return (
      <React.Fragment>
        ...
        <List as="ol">
          <List.Item as="li">
            Download the new version of the <b>Dapplets</b> browser extension{' '}
            <a
              href="https://github.com/dapplets/dapplet-extension/releases/latest/download/dapplet-extension.zip"
              target="_blank"
            >
              <b>here</b>
            </a>
          ...
          <List.Item as="li">
            Open{' '}
            <a onClick={this._openExtensionsHandler} style={{ cursor: 'pointer' }}>
              chrome://extensions
            </a>{' '}
            in a new tab
          </List.Item>
          ...
          <List.Item as="li">
            <p>
              <b>Drag and drop</b> the downloaded file into the extensions page. The extension will
          ...
          <List.Item as="li">
            <p>
              If you are using Ubuntu or another Linux OS the Dapplets extension can disappear from
              the Chrome Extensions after restarting the PC. To avoid this unzip the archive and
              instead of drag and drop use the <b>Load unpacked</b> button to add the extension
            </p>
