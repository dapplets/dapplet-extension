...
import { Button, Comment, Header, Message } from 'semantic-ui-react'
...
export class SelectWallet extends React.Component<Props, State> {
  ...
  render() {
    ...
    const connectedWallets = s.descriptors
      ...
      .filter((x) => (x.chain ? x.chain === p.chain : true))
    ...
    return (
      <div style={{ padding: '30px 20px' }}>
        <Message>
          ...
          <p>
            You are choosing a wallet for <b>{p.app}</b> application in <b>{p.chain}</b> chain.
          </p>
        </Message>
        ...
        {connectedWallets.length > 0 ? (
          <>
            ...
            <Comment.Group>
              ...
              <Message info style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
                <p>
                  Don't see your account here? You can <b>change an active account</b> in a
                  connected wallet or{' '}
                </p>
          ...
          <Message warning style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center' }}>
            ...
            <p>
              You can <b>change an active account</b> in a connected wallet or{' '}
            </p>
